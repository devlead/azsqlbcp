...
Setup<BuildData>(
    static context =>
    {
        ...
        var projectPath = projectRoot.CombineWithFilePath("azsqlbcp/azsqlbcp.csproj");
        ...
        return new BuildData(
            ...
            new DotNetMSBuildSettings()
                ...
                .WithProperty("PackageTags", "tool;azure;sql;bulkcopy;bcp")
                .WithProperty("PackageDescription", "Azure SQL Bulk Copy .NET Tool - Parallel SqlBulkCopy of tables between Azure SQL databases.")
                .WithProperty("RepositoryUrl", "https://github.com/devlead/azsqlbcp.git")
